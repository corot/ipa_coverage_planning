		...
		const std::string& classifier_storage_path)
{
	...
	cv::Mat hallway_features_mat(hallway_features.size(), lsf.get_feature_count(), CV_32SC1);
	...
	cv::Mat room_features_mat(room_features.size(), lsf.get_feature_count(), CV_32SC1);
